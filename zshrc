...
export PATH="/home/tbent/bin:/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/usr/games:/usr/local/games"
...
export PATH=$PATH:/usr/include/openmpi
...
if [ $? -eq 0 ]; then
    ...
    if [ -f "/home/tbent/.miniconda3/etc/profile.d/conda.sh" ]; then
        . "/home/tbent/.miniconda3/etc/profile.d/conda.sh"
    else
        export PATH="/home/tbent/.miniconda3/bin:$PATH"
    fi
fi
unset __conda_setup
# <<< conda initialize <<<
