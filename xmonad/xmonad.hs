...
--
myWorkspaces = ["1:code","2:term","3:web","4:todo"] ++ map show [5..9]
...
myManageHook = composeAll
    ...
    , className =? "Tk"             --> doFloat -- matplotlib
    , className =? "#2\","          --> doFloat -- matplotlib
    , className =? "#3\","          --> doFloat -- matplotlib
    , className =? "#4\","          --> doFloat -- matplotlib
    , className =? "#5\","          --> doFloat -- matplotlib
    , className =? "#6\","          --> doFloat -- matplotlib
...
myKeys conf@(XConfig {XMonad.modMask = modMask}) = M.fromList $
  ...
  -- Adjust to a newly plugged in screen
  , ((modMask .|. controlMask, xK_s),
     spawn "adjust_to_new_screen")
